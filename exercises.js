...
console.log('is GT:', isGreaterThan(4,2));
...
console.log('bigBird (3):', bigBird('cat'));
console.log('bigBird (4):', bigBird('deer'));
...
console.log('notEqual(!=)', notEqual('success','fail'));
console.log('notEqual(==)', notEqual('fail','fail'));
...
console.log('club entry:',daClub(35,20));
...
console.log('grad:',graduation(110,true));
...
console.log('train:',moneyTrain(100));
